...
typedef struct _pqof_class_entry {
    ...
    _pqof_class_entry(const QString &qt_class_name,
                      const QString &pq_class_name,
                      const QMetaObject &metaObject)
    {
        this->qt_class_name = qt_class_name;
        this->pq_class_name = pq_class_name;
...
public:
    ...
    zval                                * getZObject(const QObject* qo);
